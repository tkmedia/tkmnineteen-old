	...
	<div class="page-container">	
		<div class="entry-content" itemprop="text">
			...
			if ($masthead_on_mobile == 'same_desktop' ) {
				...
				if( $page_top_slider_style == 'manual_split' ):
					get_template_part('partials/masthead-split-slider');
				endif;
			} 
			...
			if ($masthead_on_mobile == 'mobile_masthead' ) {
				...
				if ( wp_is_mobile() ) {
					...
					if( $mobile_page_top_slider_style == 'manual_split' ):
						get_template_part('partials/masthead-split-slider-mobile');
					endif;
			...
			if(!empty($thecontent)) { ?>
				<section id="the_content" itemprop="text" class="page_section">
					...
					wp_link_pages(
						array(
							'before' => '<div class="page-links">' . __( 'Pages:', 'tkmnineteen' ),
							'after'  => '</div>',
						)
					);
					?>
