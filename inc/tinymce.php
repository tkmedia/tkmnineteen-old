...
**/
  ...
  * @return array
  */
 function tkmnineteen_mce_editor_buttons( $buttons ) {
 	array_unshift( $buttons, 'styleselect' );
 	return $buttons;
 }
 add_filter( 'mce_buttons_2', 'tkmnineteen_mce_editor_buttons' );
 ...
 add_filter( 'tiny_mce_before_init', 'tkmnineteen_mce_before_init' );

/* ---------------------------------------------------------------------------
 * Add Font Size to Wordpress Visual Editor
 * --------------------------------------------------------------------------- */
function tkmnineteen_buttons( $buttons ) {

    array_unshift( $buttons, 'fontsizeselect' );
    return $buttons;
  }
add_filter( 'mce_buttons_2', 'tkmnineteen_buttons' );

function tkmnineteen_font_size( $initArray ){
...
add_filter( 'tiny_mce_before_init', 'tkmnineteen_font_size' );
