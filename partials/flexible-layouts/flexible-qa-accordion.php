<?php 
$qa_accordion_block_width = get_sub_field('qa_acc_block_width');
$qa_accordion_order = get_sub_field('qa_acc_order');
$qa_accordion_mobile = get_sub_field('qa_acc_mobile');
$qa_accordion_hide_mobile = get_sub_field('qa_acc_hide_mobile');
$qa_accordion_break = get_sub_field('qa_acc_break');
$qa_accordion_block_align = get_sub_field('qa_acc_block_align');

$qa_accordion_title = get_sub_field('qa_acc_title');
$page_qa_subtitle = get_sub_field('flex_page_qa_subtitle');
$qa_accordion_style = get_sub_field('qa_acc_style');
$page_qa_title_a = get_sub_field('qa_acc_title_a');
$qa_accordion_cols = get_sub_field('qa_acc_cols');
$qa_accordion_icon = get_sub_field('qa_acc_icon');
$qa_accordion = get_sub_field('qa_acc');
$qa_accordion_animation = get_sub_field('qa_acc_animation');
		...
		<div class="content_page_qa flexible_page_element qa_icon_<?php echo $qa_accordion_icon; ?>" itemprop="text">
			<div class="page_qa_wrap style_arrow">
				...
				<?php if( $qa_accordion_style == 'tabs' ) { ?>		
					...
					<?php if( have_rows('qa_acc') ): ?>
						<ul class="resp-tabs-list hor_1 col-sm-5">
						<?php $i = 1; while( have_rows('qa_acc') ): the_row(); 
							// vars
							$qa_tabs_q = get_sub_field('qa_acc_question');
							?>								
						...
						<?php $i = 1; while( have_rows('qa_acc') ): the_row();
							// vars
							$qa_tabs_a = get_sub_field('qa_acc_answer');
							?>								
					...
					<?php if( have_rows('qa_acc') ): ?>
						<div class="page_qa_row page_qa_row_accordion">
							<div class="page_qa_col row-flex">
								<?php $i = 1; while (have_rows('qa_acc')) : the_row();
									$accordion_question = get_sub_field('qa_acc_question');
									$accordion_answer = get_sub_field('qa_acc_answer'); ?>
