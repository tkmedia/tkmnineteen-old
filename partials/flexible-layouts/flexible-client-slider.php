<?php 
$client_slider_width = get_sub_field('client_s_block_width');
$client_slider_mobile_cols = get_sub_field('client_s_mobile');
$client_slider_hide_mobile = get_sub_field('client_s_hide_mobile');
$client_slider_order = get_sub_field('client_s_order');
$client_slider_animation = get_sub_field('client_s_animation');
...
$client_slider_size = get_sub_field('client_s_size');

$client_slider_image_page = get_sub_field( 'client_s_image' );
$client_slider_image_effect = get_sub_field( 'client_s_image_effect' );
...
$flex_client_title = get_sub_field('client_s_title');
$flex_client_title_size = get_sub_field('client_s_title_size');
$flex_client_title_color = get_sub_field('client_s_title_color');
$flex_client_title_align = get_sub_field('client_s_title_align');
$flex_client_subtitle = get_sub_field('client_s_subtitle');
$flex_client_subtitle_size = get_sub_field('client_s_subtitle_size');
$flex_client_subtitle_color = get_sub_field('client_s_subtitle_color');
				...
				<div class="client_slider_col gallery_slider_image">
					<div class="summary-gallery-new">
						<div class="full-nomargin">
						    <div class="swiper-container client-top-<?php echo $count;?>">
							    <div class="swiper-wrapper">
								<?php $client_item = 1; while ( have_rows('client_s_repeater') ) : the_row();
								$client_img = get_sub_field('client_s_r_img');
								$client_title = get_sub_field('client_s_r_title');
								$client_title_color = get_sub_field('client_s_r_title_color');
								$client_subtitle = get_sub_field('client_s_r_subtitle');
								$client_link = get_sub_field('client_s_r_link');
								?>
									<div class="client_slide_item swiper-slide">
