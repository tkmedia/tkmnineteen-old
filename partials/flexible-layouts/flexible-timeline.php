<?php 
$timeline_block_width = get_sub_field('timeline_block_width');
$timeline_mobile_cols = get_sub_field('timeline_mobile');
$timeline_hide_mobile = get_sub_field('timeline_hide_mobile');
$timeline_order = get_sub_field('timeline_order');
$timeline_animation = get_sub_field('timeline_animation');
$timeline_break = get_sub_field('timeline_break');
$timeline_block_align = get_sub_field('timeline_block_align');

$timeline_block = get_sub_field('timeline_block');
$timeline_count = get_sub_field('timeline_count');
$timeline_count_mobile = get_sub_field('timeline_count_mobile');
						...
						<div class="timeline_block_row_wrap">
						    ...
						    <div class="swiper-container timeline_container timeline_block_<?php echo $count;?>">
								...
								<?php while( have_rows('timeline_block') ): the_row(); 
									$flex_timeline_block_date = get_sub_field('timeline_block_date');
									$flex_timeline_block_content = get_sub_field('timeline_block_content');
									?>
