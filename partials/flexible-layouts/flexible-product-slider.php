<?php 
$product_slider_block_width = get_sub_field('prod_slider_block_width');
$product_slider_mobile = get_sub_field('prod_slider_mobile');
$product_slider_hide_mobile = get_sub_field('prod_slider_hide_mobile');
$product_slider_order = get_sub_field('prod_slider_order');
$product_slider_break = get_sub_field('prod_slider_break');
$product_slider_block_align = get_sub_field('prod_slider_block_align');

$product_slider_row = get_sub_field('prod_slider_row');
$product_slider_title = get_sub_field('prod_slider_title');
$product_slider_title_align = get_sub_field('prod_slider_title_align');
$product_slider_title_color = get_sub_field('prod_slider_title_color');
$product_slider_title_size = get_sub_field('prod_slider_title_size');
$product_slider_slider_count = get_sub_field('prod_slider_count');
$product_slider_style = get_sub_field('prod_slider_style');
$product_slider_animation = get_sub_field('prod_slider_animation');
