<?php 
$bulletin_list_block_width = get_sub_field('bull_block_width');
$bulletin_list_mobile_cols = get_sub_field('f_bull_mobile');
$bulletin_list_hide_mobile = get_sub_field('f_bull_hide_mobile');
$bulletin_list_order = get_sub_field('f_bull_order');
$bulletin_list_break = get_sub_field('f_bull_break');
$bulletin_list_block_align = get_sub_field('f_bull_block_align');
$bulletin_list_animation = get_sub_field('f_bull_animation');
...
$bulletin_list_img_num = get_sub_field('bull_img_num');
$bulletin_list_img_mobile_num = get_sub_field('bull_img_mobile_num');
$bulletin_list_size = get_sub_field('f_bull_size');
$bulletin_list_icon_size = get_sub_field('f_bull_icon_size');
$bulletin_list_img_size = get_sub_field('f_bull_img_size');
			...
			<div class="bulletin_list_wrap">
				...
				<?php if( have_rows('flex_bull') ): ?>
					...
					<?php while( have_rows('flex_bull') ): the_row(); 
						...
						$bulletin_list_title = get_sub_field('bull_title');
						$bulletin_list_text = get_sub_field('bull_text');
						$bulletin_icon_font_color = get_sub_field('bull_icon_font_color');
						
						$bulletin_list_link = get_sub_field('bull_link');
						$bulletin_list_title_color = get_sub_field('bull_title_color');
						$bulletin_list_title_size = get_sub_field('bull_title_size');
						$bulletin_list_text = get_sub_field('bull_text');
						$bulletin_list_text_color = get_sub_field('bull_text_color');
						$bulletin_list_text_size = get_sub_field('bull_text_size');
						$bulletin_list_icon_img_bw = get_sub_field('bull_icon_img_bw');
