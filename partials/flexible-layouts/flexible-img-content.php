<?php 
$img_content_width = get_sub_field('f_img_con_width');
$img_content_order = get_sub_field('f_img_con_order');
$img_content_mobile = get_sub_field('f_img_con_mobile');
$img_content_hide_mobile = get_sub_field('f_img_con_hide_mobile');
$img_content_break = get_sub_field('f_img_con_break');
$img_content_block_align = get_sub_field('f_img_con_block_align');
$img_content_animation = get_sub_field('f_img_con_animation');

$img_content_style = get_sub_field('f_img_con_style');
$img_content_type = get_sub_field('f_img_con_type');
$img_content_title = get_sub_field('f_img_con_title');
$img_content_subtitle = get_sub_field('f_img_con_subtitle');
$img_content_title_h = get_sub_field('f_img_con_title_h');
$img_content_title_s = get_sub_field('f_img_con_title_s');
$img_content_title_color = get_sub_field('f_img_con_title_color');
$img_content_subtitle_color = get_sub_field('f_img_con_subtitle_color');
$img_content_text_color = get_sub_field('f_img_con_text_color');

$img_content_img = get_sub_field('f_img_con_img');
$img_content_img_size = get_sub_field('f_img_con_img_size');
$img_content_text_f = get_sub_field('f_img_con_text_f');
$img_content_align = get_sub_field('f_img_con_align');
$img_content_btn = get_sub_field('f_img_con_btn');
$img_content_link = get_sub_field('f_img_con_link');
$img_content_btn_color = get_sub_field('f_img_con_btn_color');	
$img_content_img_layout = get_sub_field('f_img_con_img_layout');
$img_content_img_bg = get_sub_field('f_img_con_img_bg');	
$img_content_img_side = get_sub_field('f_img_con_img_side');	
$img_col_layout = get_sub_field('f_img_con_col_layout');
$img_content_text_color = get_sub_field('f_img_con_text_color');					
$img_content_logo = get_sub_field('f_img_con_logo');
