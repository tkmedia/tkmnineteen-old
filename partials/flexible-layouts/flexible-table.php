<?php 
$table_block_width = get_sub_field('table_block_width');
$table_mobile_cols = get_sub_field('table_mobile');
$table_hide_mobile = get_sub_field('table_hide_mobile');
$table_order = get_sub_field('table_order');
$table_break = get_sub_field('table_break');
$table_block_align = get_sub_field('table_block_align');
$table_animation = get_sub_field('table_animation');

$table_title = get_sub_field('table_title');
$table_subtitle = get_sub_field('table_subtitle');
$table_title_size = get_sub_field('table_title_size');
$table_subtitle_size = get_sub_field('table_subtitle_size');
$table_title_a = get_sub_field('table_title_a');
$table_title_color = get_sub_field('table_title_color');
$table_subtitle_color = get_sub_field('table_subtitle_color');

$flex_table = get_sub_field('table_block');
