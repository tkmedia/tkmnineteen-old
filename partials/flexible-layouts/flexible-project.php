<?php
$project_block_width = get_sub_field('proj_block_width');
$project_mobile_cols = get_sub_field('proj_mobile');
$project_order = get_sub_field('proj_order');
$project_hide_mobile = get_sub_field('proj_hide_mobile');
$project_break = get_sub_field('proj_break');
$project_block_align = get_sub_field('proj_block_align');

$project_title = get_sub_field('proj_title');
$project_title_color = get_sub_field('proj_title_color');
$project_title_size = get_sub_field('proj_title_size');
$project_title_type = get_sub_field('proj_title_type'); 
$project_title_position = get_sub_field('proj_title_position');
$project_title_side = get_sub_field('proj_title_side');
$project_pretitle = get_sub_field('proj_pretitle');
$project_pretitle_color = get_sub_field('proj_pretitle_color');
$project_pretitle_size = get_sub_field('proj_pretitle_size');

$project_button_first = get_sub_field('proj_button_first');
$project_button_second = get_sub_field('proj_button_second');
$project_button_first_link = get_sub_field('proj_button_first_link');
$project_button_second_link = get_sub_field('proj_button_second_link');
$project_image_size = get_sub_field('proj_image_size');
$project_image = get_sub_field('proj_image');

$project_animation = get_sub_field('proj_animation');
									...
									<div class="custom_icon_btn flex_project_btn project_button_first">
										<a href="<?php echo $project_button_first_link; ?>" class="masthead_btn_link">
											<button class="section_readmore_link watch_btn hoverLink">
												...
												<?php } else { ?>
												<?php _e('View Project', 'tkmnineteen'); ?>
												<?php } ?>
											</button>
										</a>
									</div>
									...
									<div class="custom_icon_btn flex_project_btn project_button_second">
										<a href="<?php echo $project_button_second_link; ?>" class="masthead_btn_link">
											<button class="section_readmore_link watch_btn hoverLink">
												...
												<?php } else { ?>
												<?php _e('All Projects', 'tkmnineteen'); ?>
												<?php } ?>
											</button>
										</a>
									</div>
