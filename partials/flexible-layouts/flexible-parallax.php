<?php 
$paralax_block_width = get_sub_field('paralax_block_width');
$paralax_order = get_sub_field('paralax_order');
$paralax_mobile = get_sub_field('paralax_mobile');
$paralax_hide_mobile = get_sub_field('paralax_hide_mobile');

$paralax_style = get_sub_field('paralax_style');
$paralax_bg = get_sub_field('paralax_bg');
$paralax_h = get_sub_field('paralax_h');
$paralax_content = get_sub_field('paralax_content');
$paralax_animation = get_sub_field('paralax_animation');
