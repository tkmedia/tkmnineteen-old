						...
						<div class="masthead_content_col col-xs-12">
							<?php if ( !is_page_template( 'page_product.php' ) ) { ?>
								<div class="masthead_clean_title">
									...
									?>
									<h1 class="entry-title masthead_content_title archive_title" itemprop="headline" style="color: <?php echo($title_color); ?>;">
										<?php if ( ! is_post_type_archive() ) { echo single_cat_title(); } else { echo post_type_archive_title(); } ?>
									</h1>
								</div>
