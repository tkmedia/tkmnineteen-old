...
//if( have_rows('content_rows') ):
	...
	$bottom_divider_position = get_sub_field('conR_bDp');		
		...
		if( $bottom_divider ) { ?>
			...
			<?php if ($bottom_divider == 'opacity-circle' ) { ?>
			...
			<?php if ($bottom_divider == 'mountains' ) { ?>
			...
			<?php } ?>
			<?php if ($bottom_divider == 'right-tilt' || $bottom_divider == 'left-tilt' ) { ?>
			...
			<?php if ($bottom_divider == 'big-clouds' ) { ?>
			...
			<?php if ($bottom_divider == 'pyramids' ) { ?>
			...
			<?php if ($bottom_divider == 'triangle' ) { ?>
			...
			<?php if ($bottom_divider == 'right-opacity-tilt' || $bottom_divider == 'left-opacity-tilt' ) { ?>
			...
			<?php if ($bottom_divider == 'opacity-triangle' ) { ?>
			...
			<?php if ($bottom_divider == 'right-arc' || $bottom_divider == 'left-arc' ) { ?>
			<svg viewBox="0 0 1280 140" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 0s573.08 140 1280 140V0z"/></svg>
			<?php } ?>
			<?php if ($bottom_divider == 'right-opacity-arc' || $bottom_divider == 'left-opacity-arc' ) { ?>
			...
			<?php } ?>
			<?php if ($bottom_divider == 'opacity-clouds' ) { ?>
			...
			<?php } ?>
			<?php if ($bottom_divider == 'opacity-waves' ) { ?>
