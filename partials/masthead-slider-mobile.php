...
$title_location = get_post_meta( get_the_ID(), 'mobile_masthead_title_location', true );
$title_hor = get_post_meta( get_the_ID(), 'mobile_masthead_title_hor', true );
$title_ver = get_post_meta( get_the_ID(), 'mobile_masthead_title_ver', true );

$btn_style = get_post_meta( get_the_ID(), 'mobile_masthead_button_style', true );
$btn1_text = get_post_meta( get_the_ID(), 'mobile_masthead_btn1_text', true );
$btn1_link = get_post_meta( get_the_ID(), 'mobile_masthead_btn1_link', true );
$btn2_text = get_post_meta( get_the_ID(), 'mobile_masthead_btn2_text', true );
$btn2_link = get_post_meta( get_the_ID(), 'mobile_masthead_btn2_link', true );
$intro_bg_color = get_post_meta( get_the_ID(), 'mobile_masthead_intro_bg_color', true );
				...
				<div class="masthead_content wrap row-flex <?php echo($title_hor); ?>-xs <?php echo($title_ver); ?>-xs <?php echo($title_location); ?>"<?php if ($title_location == 'slider_content_bottom' ) { ?> style="background:<?php echo($intro_bg_color); ?>;"<?php } ?>>
					<div class="masthead_content_container col-xs-12">
						...
						if ($title_location == 'slider_content_bottom' ) {
							$title_color = get_post_meta( get_the_ID(), 'mobile_masthead_title_color', true );
							$text_color = get_post_meta( get_the_ID(), 'mobile_masthead_text_color', true );
							$btn_color = get_post_meta( get_the_ID(), 'mobile_masthead_btn_color', true );
							$btn_bg_color = get_post_meta( get_the_ID(), 'mobile_masthead_btn_bg_color', true );
							$page_masthead_title = get_post_meta( get_the_ID(), 'masthead_title', true );
							$page_masthead_text = get_post_meta( get_the_ID(), 'masthead_text', true );
